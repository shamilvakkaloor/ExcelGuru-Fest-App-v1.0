...
function heritageWithPhoto() {
  return {
    ...
    elements: [
      ...
      el("img7", "image", { x: 128.5, y: 44.5, w: 40, h: 52, src: "{photo}", radius: 26, fit: "cover" }),
...
function heritageWinner() {
  return {
    ...
    elements: [
      ...
      el("b7", "box", { x: 54, y: 58, w: 102, h: 118, fill: "linear-gradient(150deg,#F5E2A6,#C9A227 56%,#826411)", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 4.90% 4.90% / 64% 64% 3% 3%" }),
      el("b8", "box", { x: 57, y: 61, w: 96, h: 115, fill: "#101538", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 5.21% 5.21% / 64% 64% 3% 3%" }),
      el("img9", "image", { x: 60, y: 64, w: 90, h: 112, src: "{photo}", radiusRaw: "50% 50% 4.44% 4.44% / 64% 64% 3% 3%", fit: "cover" }),
...
function heritageRanksPoster() {
  return {
    ...
    elements: [
      ...
      el("b9", "box", { x: 157, y: 78, w: 26, h: 32, fill: "linear-gradient(150deg,#F5E2A6,#C9A227 58%,#826411)", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 15.38% 15.38% / 62% 62% 4% 4%" }),
      el("img10", "image", { x: 158.2, y: 79.2, w: 23.6, h: 29.6, src: "{rank1photo}", radiusRaw: "50% 50% 12.71% 12.71% / 62% 62% 4% 4%", fit: "cover" }),
      ...
      el("b17", "box", { x: 158, y: 113, w: 24, h: 29, fill: "linear-gradient(150deg,#E9E4DA,#A9A29A)", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 12.50% 12.50% / 62% 62% 4% 4%" }),
      el("img18", "image", { x: 159, y: 114, w: 22.4, h: 27.4, src: "{rank2photo}", radiusRaw: "50% 50% 13.39% 13.39% / 62% 62% 4% 4%", fit: "cover" }),
      ...
      el("b25", "box", { x: 158, y: 145, w: 24, h: 29, fill: "linear-gradient(150deg,#E2B584,#A0632C)", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 12.50% 12.50% / 62% 62% 4% 4%" }),
      el("img26", "image", { x: 159, y: 146, w: 22.4, h: 27.4, src: "{rank3photo}", radiusRaw: "50% 50% 13.39% 13.39% / 62% 62% 4% 4%", fit: "cover" }),
...
function heritageRanksScreen() {
  return {
    ...
    elements: [
      ...
      el("b9", "box", { x: 126.3, y: 50, w: 86, h: 82, fill: "linear-gradient(150deg,#F5E2A6,#C9A227 56%,#826411)", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 4.65% 4.65% / 62% 62% 3% 3%" }),
      el("b10", "box", { x: 129.3, y: 53, w: 80, h: 79, fill: "#101538", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 5.00% 5.00% / 62% 62% 3% 3%" }),
      el("img11", "image", { x: 132.3, y: 56, w: 74, h: 76, src: "{rank1photo}", radiusRaw: "50% 50% 4.05% 4.05% / 62% 62% 3% 3%", fit: "cover" }),
      ...
      el("b18", "box", { x: 36.3, y: 66, w: 58, h: 58, fill: "linear-gradient(150deg,#E9E4DA,#8F8880)", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 5.17% 5.17% / 60% 60% 3% 3%" }),
      el("b19", "box", { x: 38.8, y: 68.5, w: 53, h: 55.5, fill: "#101538", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 5.66% 5.66% / 60% 60% 3% 3%" }),
      el("img20", "image", { x: 41.3, y: 71, w: 48, h: 53, src: "{rank2photo}", radiusRaw: "50% 50% 4.17% 4.17% / 60% 60% 3% 3%", fit: "cover" }),
      ...
      el("b27", "box", { x: 244.3, y: 66, w: 58, h: 58, fill: "linear-gradient(150deg,#E2B584,#8F5726)", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 5.17% 5.17% / 60% 60% 3% 3%" }),
      el("b28", "box", { x: 246.8, y: 68.5, w: 53, h: 55.5, fill: "#101538", stroke: "none", strokeWidth: 0, radiusRaw: "50% 50% 5.66% 5.66% / 60% 60% 3% 3%" }),
      el("img29", "image", { x: 249.3, y: 71, w: 48, h: 53, src: "{rank3photo}", radiusRaw: "50% 50% 4.17% 4.17% / 60% 60% 3% 3%", fit: "cover" }),
...
function kanchiWithPhoto() {
  return {
    ...
    elements: [
      ...
      el("img5", "image", { x: 126.5, y: 38.5, w: 44, h: 44, src: "{photo}", fit: "cover" }),
...
function kanchiWinner() {
  return {
    ...
    elements: [
      ...
      el("img7", "image", { x: 66, y: 65, w: 78, h: 78, src: "{photo}", fit: "cover" }),
...
function annWinner() {
  return {
    ...
    elements: [
      ...
      el("img6", "image", { x: 59, y: 142, w: 92, h: 92, src: "{photo}", fit: "cover" }),
...
function annCertPhoto() {
  return {
    ...
    elements: [
      ...
      el("img4", "image", { x: 24, y: 62, w: 52, h: 52, src: "{photo}", fit: "cover" }),
